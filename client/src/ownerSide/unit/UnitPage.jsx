        ...
        {showLoadingScreen ? (
          ...
          >
            ...
            <div className={`mt-2 flex justify-between`}>
              ...
              >
                New <span className={`hidden md:inline`}>Unit</span>
              </button>
            </div>
            ...
            >
              {/* list title */}
              <div
                className={`p-3 font-poppins text-sm font-semibold grid grid-cols-3 md:grid-cols-6 justify-between`}
              >
                <h1>Unit Name</h1>
              ...
              {allUnits.length == 0 ? (
                ...
                allUnits_statusSort.map((unit) => (
                  <div
                    key={unit._id}
                    className={`p-3 font-nunito-sans md:text-base text-sm grid grid-cols-3 md:grid-cols-6 justify-between`}
                  >
                    <h1
                      className={`${
                        unit.status == "Vacant"
